...
public class OrderService {
    ...
    @Transactional
    public Long createdOrder(String customerName, String address, String email, String phone, String note, List<CartItem> cartItems){
    ...
    @Transactional
    public void saveInvoice(Long orderId, int quantity, long totalAmount) {
        Order order = orderRepository.findById(orderId).orElseThrow(() -> new RuntimeException("Order not found"));
