    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception{
        return http
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/css/**", "/js/**", "/fonts/**", "/sass/**", "/image/**", "/img/**", "/home/**", "/cart/**", "/forgot-password", "/reset-password", "/product/**", "/feedback/**", "/", "/oauth/**", "/register", "/products", "/cart/**")
                        .permitAll()
