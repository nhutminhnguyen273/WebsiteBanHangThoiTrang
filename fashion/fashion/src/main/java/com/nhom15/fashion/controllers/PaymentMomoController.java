...
public class PaymentMomoController {
    ...
    @GetMapping("/initiate")
    public String showPaymentForm(@RequestParam("orderId") Long orderId, @RequestParam("totalPrice") long amount, Model model) {
    ...
    @PostMapping("/momo")
    public String initiatePayment(@RequestParam("orderId") Long orderId, @RequestParam("amount") long amount, Model model) {
        try {
            String requestId = UUID.randomUUID().toString();
            Long momoOrderId = orderId;
