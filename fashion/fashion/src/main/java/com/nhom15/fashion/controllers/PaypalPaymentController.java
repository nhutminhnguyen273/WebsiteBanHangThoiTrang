...
public class PaypalPaymentController {
    ...
    public String showPaymentPage(@RequestParam("orderId") Long orderId, @RequestParam("totalPrice") double totalPrice, Model model){
    ...
    @PostMapping("/pay")
    public String pay(@RequestParam("totalPrice") double price, @RequestParam("orderId") Long orderId, HttpServletRequest request, RedirectAttributes redirectAttributes){
